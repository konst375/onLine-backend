...
public class PostController {
    ...
    @PostMapping("/create")
    public ResponseEntity<UserPostDto> createUserPost(PostRequestDto dto, @AuthenticationPrincipal User user) {
    ...
    @PutMapping("/{postId}")
    public ResponseEntity<BasePostDto> updatePost(PostRequestDto dto,
