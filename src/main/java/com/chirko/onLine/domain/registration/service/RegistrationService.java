package com.chirko.onLine.domain.registration.service;
...
import com.chirko.onLine.domain.registration.event.OnResendingConfirmationLinkEvent;
import com.chirko.onLine.domain.registration.event.OnSuccessfulRegistrationEvent;
...
import com.chirko.onLine.domain.user.entity.enums.Role;
